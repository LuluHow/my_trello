...
use TW\DashboardBundle\Entity\Tasks;
use TW\DashboardBundle\Form\TasksType;
...
class TasksController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tasks = $em->getRepository('TWDashboardBundle:Tasks')->findAll();
    ...
    {
        $task = new Tasks();
        $form = $this->createForm('TW\DashboardBundle\Form\TasksType', $task);
    ...
    {
        $deleteForm = $this->createDeleteForm($task);
        $editForm = $this->createForm('TW\DashboardBundle\Form\TasksType', $task);
